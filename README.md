...
#
# Fits used previously is:
# In Plotter/langaus.C.bak.EJ260
# L 064: plhi[1]=50.0
# L 303: TH1F* hPed = new TH1F("hPed","Pedestal",10,-1.0,0.0);
# L 305: TF1 myfit = TF1("myfit","gaus",-1.0,0.);
#
# Note: the pedestal gaussian fit wasn't good for range -1 and 0
# Therefore, change to use exact same range [-1.5,-0.15]
