...
def DrawHistSimple(myfiles_, plotSets_, outDir_, fTag_, doselabel_, hxrng_, options_, debug_=False):
    ...
    for nf, fl in sorted(plotSets_.items()):
        ...
        for ni in range(len(fl)):
            ...
            trees_[fntmp].Draw("area*1.e9+0.12438>>myhist_%s"%(fNames_[fntmp]),"","")
        ...
        for ni in range(len(fl)):
            ...
            if ni == 0:
                ...
                #myhist_[fNames_[fntmp]].GetYaxis().SetRangeUser(0,1.2e4)
                myhist_[fNames_[fntmp]].GetYaxis().SetRangeUser(5.e-2,1.e7)
