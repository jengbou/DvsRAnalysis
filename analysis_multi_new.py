...
if __name__ == '__main__':
    ...
    fitrng = {}
    ## S10362-33-050C EJ260
    fitrng["amp"]  = [250,-0.02,0.25] # energy_amp in V*ns
    fitrng["ped"]  = [100,-1.0,0.0]   # energy_ped in V*ns
    fitrng["sig"]  = [20,-0.3,10.]    # energy_sig in V*ns
    fitrng["eng"]  = [20,-0.6,25.]    # energy_all in Npe
    fitrng["plot"] = [20,-1.0,40.]    # energy_all in Npe

    ## S10362-33-050C EJ200
##    fitrng["amp"]  = [250,-0.05,0.75] # energy_amp in V*ns
##    fitrng["ped"]  = [100,-1.0,0.0]   # energy_ped in V*ns
##    fitrng["sig"]  = [20,-0.5,25.]    # energy_sig in V*ns
##    fitrng["eng"]  = [20,-0.5,50.]    # energy_all in Npe
##    fitrng["plot"] = [20,-1.0,100.]   # energy_all in Npe
    ...
    for line in list_input:
        ...
        valPhys[sampleName], myHists[sampleName] = ana[sampleName].run_energy_all(fitrange=fitrng)
